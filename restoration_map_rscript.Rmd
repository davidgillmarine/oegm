...
As you work on this "restoration_map_rscript.Rmd" - save like you normally do, with the save symbol (top left). Then, make sure you're in the "Git" window (upper right). Check the Stage box to the left of this "restoration_map_rscript.Rmd" file name. Then, select "Commit." In the pop-up, type a message in "Commit message" (whatever note would be helpful to describe what you just changed in the script), then, click "commit." This will save your changes locally
...
pacman::p_load(rio,rgeos,treemap,gtools,cowplot,rnaturalearth,rnaturalearthdata,tidyverse, ggplot2)
