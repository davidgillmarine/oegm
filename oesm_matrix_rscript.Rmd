...
all.data<-import(paste0(inputdir,"20231204_All_Papers.xlsx"), which="FULL Data Extraction Sheet",skip =2, .name_repair = "universal") %>% 
...
drop.down.lists<-import(paste0(inputdir,"20231204_All_Papers.xlsx"), which="Dropdowns", skip =1, .name_repair = "universal")
